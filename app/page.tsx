    ...
    <>
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-4 border-2 border-primary rounded-md p-6">
            <h1 className="scroll-m-20 text-xl font-extrabold tracking-tight">Developer at <a className="text-blue-600" href="https://www.blockcmd.com"><span className="inline-flex"><span className="mr-1">BlockCMD</span><ExternalLink /></span></a></h1>
            <p>A product lab specializing in crypto and onchain protocols</p>
          </div>
          <div className="flex flex-col gap-4 border-2 border-primary rounded-md p-6">
            <h1 className="scroll-m-20 text-xl font-extrabold tracking-tight">Core contributor in <a className="text-blue-600" href="https://www.buildstation.org"><span className="inline-flex"><span className="mr-1">buildstation</span><ExternalLink /></span></a></h1>
            <p>A community initiative and grant platform for builders.</p>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-4 border-2 border-primary rounded-md p-6">
            <h1 className="scroll-m-20 text-xl font-extrabold tracking-tight">Developer Advocate at <a className="text-blue-600" href="https://kaia.io"><span className="inline-flex"><span className="mr-1">Kaia</span><ExternalLink /></span></a></h1>
            <p>A leading Layer 1 public blockchain designed for tomorrow&apos;s on-chain world.</p>
          </div>
          <div className="flex flex-col gap-4 border-2 border-primary rounded-md p-6">
            <h1 className="scroll-m-20 text-xl font-extrabold tracking-tight">Editor at <a className="text-blue-600" href="https://www.defi.vn"><span className="inline-flex"><span className="mr-1">DeFi.vn</span><ExternalLink /></span></a></h1>
